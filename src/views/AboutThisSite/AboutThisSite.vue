<template>
  <main aria-label="About This Site Section" class="flex flex-col items-center justify-center w-full p-6">
    ...
    <section 
      ...
      class="w-full max-w-3xl text-center mb-10 pt-4"
    >
      <h1 
    ...
    <Modal
      v-if="currentFeatureIndex !== null"
      :is-open="isFeatureModalOpen"
      :on-close="closeFeatureModal"
      :title="modalFeatures[currentFeatureIndex].category"
      :on-next="handleFeatureNext"
      :on-previous="handleFeaturePrevious"
      :total-pages="modalFeatures.length"
      :current-page="currentFeatureIndex"
      :is-expanded="isFeatureModalExpanded"
      :on-toggle-expand="toggleFeatureModalExpand"
